<template>
  ...
  >
    <div class="relative">
      ...
      <div v-if="place.paid" class="absolute top-3 left-3 text-green-500 text-sm font-bold uppercase backdrop-blur-md px-3 py-1 rounded-full border border-green-500">
         Paid
      </div>
