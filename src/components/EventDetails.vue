...
<div class="w-full min-h-screen flex flex-col items-center px-4 pb-14 pt-14 bg-[#1A1A1A] text-white">
        ...
        <div class="mt-6">
            ...
            <div class="mt-4 space-y-3 text-gray-300 text-lg">
                <div class="flex items-center">
                    ...
                    <a :href="`https://www.google.com/maps/dir/?api=1&destination=${encodeURIComponent(event?.location)}`" target="_blank" class="text-white font-semibold hover:underline flex items-center">
                        {{ event?.location }}
    ...
    <!-- Book Now Button -->
    <button @click="bookNow" class="w-full max-w-5xl mt-6 bg-yellow-500 text-black py-3 rounded-lg text-center font-semibold hover:bg-green-600 transition">
